...
<div class="masthead-courses bg-general-english">
      <div class="center">
        ...
        <div>
          ...
          <p>
          Our General English courses are based on a communicative and task-based approach, which means students always focus on effective real-life communication and ways of practising and achieving it.</p>
        </div>
...
<div class="masthead-courses bg-exam-preparation">
      <div class="center">
        ...
        <div>
          ...
          <p>
            Improve your English and focus on developing skills and techniques to succeed in your exam.
          </p>
        </div>
...
elseif(is_page(icl_object_id(6093, 'page'))) { ?>  <!--Learn Other Languages-->
    ...
    <div class="page-wrap">
      <div class="inner"> 
        <div class="c-hero-content">
          <h1>Learn Other Languages</h1>
          <p>
            We offer a variety of part-time language courses in Spanish, Portuguese, German, French and Italian.
          </p>
        </div>
      </div> 
    </div>
...
elseif(is_page(icl_object_id(34, 'page'))) { ?>  <!--Atlas Junior-->
...
<div class="masthead-courses bg-junior">
      <div class="center">
        ...
        <div>
          <h1>Atlas Junior</h1>
          <p>
            Study English in Ireland, the UK or USA and learn about Irish, British and American culture in a fun and challenging environment.
          </p>
        </div>
...
elseif(is_page(array(427,2369))) { ?>  <!--Our Courses-->
